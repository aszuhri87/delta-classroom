                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" placeholder="Student Name" name="name"
                                    id="name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" placeholder="Student Phone Number"
                                    name="phone_number" id="phone_number">
                            </div>
                            <div class="form-group">
                                <label for="phone_number">Email</label>
                                <input type="email" required class="form-control" placeholder="Student Email"
                                    name="email" id="email">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" placeholder="Student Number"
